...
for benchid in range(0,100):
    ...
    if sys.argv[1]=="low":
       ...
       f1=open("../trace_files/scene_benchmarks/low_obstacle_enpose/low_obstacle_encodepose_"+benchidstr+".pkl","rb")
    else:
        f=open("../trace_files/scene_benchmarks/moving_1030_10_high/obstacles_"+benchidstr+"_pose.pkl","rb")
        f1=open("../trace_files/scene_benchmarks/high_obstacle_enpose/high_obstacle_encodepose_"+benchidstr+".pkl","rb")
