...
##binary code
fourbin={4:{1:"00",2:"01",3:"10",4:"11"},8:{1:"000",2:"001",3:"010",4:"011",5:"100",6:"101",7:"110",8:"111"},16:{1:"0000",2:"0001",3:"0010",4:"0011",5:"0100",6:"0101",7:"0110",8:"0111",9:"1000",10:"1001",11:"1010",12:"1011",13:"1100",14:"1101",15:"1110",16:"1111"}}
...
for benchid in range(0,100):
    ...
    if sys.argv[1]=="low":
       ...
       #f=open("../trace_generation/scene_benchmarks/dens6/obstacles_"+benchidstr+"_pose.pkl","rb")
    else:
    ...
    code_pred_quant=np.digitize(xtest_pred[:, 1:7],bins,right=True)
    f.close()
    colldict={}
    ##
    ...
    for i in range(0,len(code_pred_quant)):
        ...
        if keyy in colldict:
            if colldict[keyy][0]>colldict[keyy][1]:
                predicted=0
